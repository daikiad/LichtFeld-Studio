...
struct VulkanGSPipelineBuffers {
    ...
    Buffer<float> grad_means_norm;       // (N) ||dL/d means_ws|| per gaussian (densification stat)
    Buffer<float> ssim_map;              // (H,W,3,4) per-channel [ssim, dMdmu1, dMdsigma1sq, dMdsigma12]
